...
public class CustomerService {
	...
	public CustomerModel signUpCustomer(CustomerModel customer) throws ResourceNotFoundException {
		if(customerRepo.findByCustContact(customer.getCustContact())!=null) throw new ResourceNotFoundException("Customer Contact is already exist");
		if(customerRepo.findByCustEmail(customer.getCustEmail())!=null) throw new ResourceNotFoundException("Customer Email is already exist");
